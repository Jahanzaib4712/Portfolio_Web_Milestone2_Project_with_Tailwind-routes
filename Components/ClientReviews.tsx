    ...
    <div className='flex flex-col text-center justify-center'>
        ...
        <p className='text-[18px] text-white opacity-75 mt-[0.5rem] mb-[1.4rem]'>
            ...
            <p className='text-[16px] text-white opacity-50 w-[90%] md:w-[50%] mx-auto '>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti nihil, repudiandae vel quasi error id assumenda voluptatibus, quia a, eos dolores nemo ea.
                 Ea voluptas nostrum aliquid voluptatum omnis explicabo libero possimus.
                 </p>
